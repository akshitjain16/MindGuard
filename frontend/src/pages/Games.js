  ...
  const games = [
    {
      ...
      path: "/games/MatchPair/index.html",
      icon: matchpairImg,
    },
    {
      name: "Stress Relief Puzzle",
      description: "Solve puzzles to clear your mind.",
      path: "/games/StressReliefPuzzle/index.html",
      icon: "/assets/stress-relief-puzzle-icon.png",
    },
    {
      name: "Breathing Exercises",
      description: "Follow breathing patterns to calm yourself.",
      path: "/games/BreathingExercises/index.html",
      icon: breathingImg,
    },
  ];
